...
button_pins = (board.D24, board.D25, board.SCK, board.MOSI, board.MISO, board.RX, board.TX, board.D4, board.D12, board.D11, board.D10, board.D9, board.D6, board.D5, board.SCL, board.SDA)
...
# ar_z = analogio.AnalogIn(board.A3)
...
while True:
    ...
    # print(" x", ax.value, "y", ay.value) # , "z", az.value, "r_z", ar_z.value)
