...
button_pins = (board.A0, board.A1, board.D24, board.D25, board.D12, board.D9, board.D10, board.D6,board.D5, board.MOSI,
               board.MISO)
...
# is pushed.    (1:up,2:left,3:down,4:right,5:1,6:2,7:3
...
modeChangeButton = digitalio.DigitalInOut(board.D4)
...
while True:
    ...
    if mode == 1:
        ...
        gp.move_joysticks(
            x=range_map(ay.value, 0, 65535, -127, 127),
            y=range_map(ax.value, 0, 65535, 127, -127),
        )
